 ...
 */
public class PrimaryControllerBAK implements Runnable{
    ...
    private AdminControllerBAK parentController;
    ...
    public AdminControllerBAK getParentController() {
        return parentController;
    }

    public void setParentController(AdminControllerBAK parentController) {
